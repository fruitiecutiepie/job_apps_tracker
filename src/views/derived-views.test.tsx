...
describe('TableView', () => {
  ...
  it('filters and sorts the Activity column, sinking rows with no silence to measure', () => {
    ...
    render(
      <TableView applications={applications} onOpen={vi.fn()} onOpenStageNotes={vi.fn()} onOpenPosting={vi.fn()} onCompleteAction={vi.fn()} onMove={vi.fn()} />,
    )
  ...
  it('sorts, opens, and moves an application without changing the data', () => {
    ...
    render(
      <TableView applications={applications} onOpen={onOpen} onOpenStageNotes={vi.fn()} onOpenPosting={vi.fn()} onCompleteAction={vi.fn()} onMove={onMove} />,
    )
  ...
  it('narrows rows with column filters without changing the data', () => {
    ...
    render(<TableView applications={applications} onOpen={vi.fn()} onOpenStageNotes={vi.fn()} onOpenPosting={vi.fn()} onCompleteAction={vi.fn()} onMove={vi.fn()} />)
  ...
  it('sorts by deadline with undated applications last', () => {
    ...
    render(
      <TableView
        ...
        onOpen={vi.fn()}
        onMove={vi.fn()}
        onOpenStageNotes={vi.fn()} onOpenPosting={vi.fn()}
...
describe('KanbanView', () => {
  ...
  it('supports opening and moving a card through its accessible controls', () => {
    ...
    render(<KanbanView applications={[record]} onOpen={onOpen} onOpenStageNotes={vi.fn()} onOpenPosting={vi.fn()} onCompleteAction={vi.fn()} onMove={onMove} />)
  ...
  it('shows the soonest invite still ahead and skips cancelled or past ones', () => {
    ...
    render(<KanbanView applications={[record]} onOpen={vi.fn()} onOpenStageNotes={vi.fn()} onOpenPosting={vi.fn()} onCompleteAction={vi.fn()} onMove={vi.fn()} />)
  ...
  it('moves a dragged card to any other state', () => {
    ...
    render(<KanbanView applications={[record]} onOpen={vi.fn()} onOpenStageNotes={vi.fn()} onOpenPosting={vi.fn()} onCompleteAction={vi.fn()} onMove={onMove} />)
  ...
  it('omits attachment filenames when there are no attachments', () => {
    render(<KanbanView applications={[application('No Files Co')]} onOpen={vi.fn()} onOpenStageNotes={vi.fn()} onOpenPosting={vi.fn()} onCompleteAction={vi.fn()} onMove={vi.fn()} />)
