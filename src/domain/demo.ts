...
const DEMO_SEEDS: readonly DemoSeed[] = [
  ...
  { company: 'Marble & Finch', role: 'Product Manager', state: 'applied', createdDaysAgo: 9, updatedDaysAgo: 9, nextAction: 'Follow up on the application', nextActionDaysFromNow: -2, notes: 'Applied with a tailored portfolio.', source: 'LinkedIn' },
